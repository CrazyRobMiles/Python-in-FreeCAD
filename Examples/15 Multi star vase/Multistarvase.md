# Multivase
![FreeCAD showing a vase made from multiple 4 pointed stars](/Examples/15%20Multi%20star%20vase/Multivase.png)

A multi-vase is made by squishing a number of vases together. This creates more interesting shaped vases, particularly if you fiddle with some of the random elements
...
# Range of values for the outer radius of the stars
outer_range=(30,30)

# Range of values for the inner radius of the stars
