...
![A line drawing of a path which contains a rounded element at one end. The vertices and the edges are labeled.](/Examples/16%20Rounded%20Rectangle%20Path/RoundedRectanglePath.png)

This shows how we can create rounded elements in a path. It creates an outline of a design for a luggage tag with a rounded end. 
```python
# Extruded Panel
