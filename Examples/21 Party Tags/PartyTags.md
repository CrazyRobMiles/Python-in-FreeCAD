# Party Tags
![A 3D view of a large number of tags with different names on them.](/Examples/21%20Party%20Tags/PartyTags.png)

This tag generator accepts a list of names and produces a tag for each name. You can print 30 or so tags at a time, depending on name length. The program produces two objects which should be combined and printed in the same way as the [tag with embedded text](/Examples/19%20Tag%20with%20embedded%20text/TagWithEmbeddedText.md)
