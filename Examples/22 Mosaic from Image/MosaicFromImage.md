# Mosaic from Image
![Freecad showing a mosaic of an old camera as an image made up of four differently coloured regions](/Examples/22%20Mosaic%20from%20Image/mosaic.png)
...
if App.ActiveDocument is not None:
    ...
    doc = App.newDocument("BlockMosaic")
    firstRun = True
...
def build_colour_shapes(img, colours, pixel_size, thickness, border=0.0, z0=0.0):
    """
    ...
    No Boolean fusion is performed because the strips do not overlap.
    """
    ...
    for y in range(depth):
        ...
        while x < width:
            ...
            # FreeCAD Y grows upward; image Y grows downward
...
def create_mosaic_stls():
    ...
    # Export each colour as its own STL
